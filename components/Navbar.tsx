  ...
  const navLinks = [
    {
      ...
      href: '/services',
      subLinks: [
        { name: 'Furnace', href: '/services/furnace' },
        { name: 'Mini Splits', href: '/services/mini-splits' },
        { name: 'Heat Pump', href: '/services/heat-pump' },
        { name: 'Air Conditioner', href: '/services/air-conditioner' },
    ...
    },
    {
      ...
      href: '/locations',
      subLinks: [
        { name: 'Middlesex County', href: '/locations/middlesex-county' },
        { name: 'Norfolk County', href: '/locations/norfolk-county' },
        { name: 'Suffolk County', href: '/locations/suffolk-county' },
        { name: 'Essex County', href: '/locations/essex-county' },
        { name: 'Plymouth County', href: '/locations/plymouth-county' },
        { name: 'Worcester County', href: '/locations/worcester-county' },
        { name: 'Bristol County', href: '/locations/bristol-county' },
